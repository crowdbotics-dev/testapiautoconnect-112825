...
## Project Structure
    ...
    ├── testapiautoconnect_112825  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_112825`
...
2. Clone this repo and `cd testapiautoconnect_112825`
